    ...
    return (
        <div>
            <img src={assets.backward} 
                className="absolute top-2 left-2 w-10 md:w-12 rotate-180 h-10 hover:opacity-[0.5] z-50" 
                alt="back" 
            ...
            {specificEvent?.EventURLs?.length > 0 ? (
                <div className="columns-2 md:columns-3 lg:columns-4 gap-2 md:gap-7 space-y-6 ml-10 md:ml-20 mr-10 md:mr-20 mt-10 md:mt-32">
